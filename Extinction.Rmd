...
For an example video of Persi making a false alert and then hearing a click at the moment she sniffs the cheetah scat, please see the Supplementary Materials.
...
Sessions 1 and 2 include false alerts with high duration, followed by decreased false alerts. When Persi does false alert, the durations are decreased. After session 11, Persi exhibits no more false alerts.
...
Despite continuing to have occasional false alerts, their duration decreases over time.
...
After one especially persistent false alert of 600 seconds (10 minutes), the duration of Madi's false alerts decrease.
