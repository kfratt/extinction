...
Figure 1. Persi's proportion of false alerts per session.
...
Figure 2. Persi's duration of false alerts per session.

Sessions 1 and 2 show an extinction burst, followed by decreased false alerts. After session 11, Persi exhibits no more false alerts.
...
Figure 4. Persi's misses per session.
...
Figure 5. Madi's proportion of false alerts per session.
...
While Madi continues to have occasional false alerts, the duration significantly decreases over time.
...
Figure 8. Madi’s Misses per Session.
